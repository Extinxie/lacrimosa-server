...
export const ScreenshotPlain = t.Object(
  {
    id: t.String(),
...
export const ScreenshotRelations = t.Object(
  {
    anime: __nullable__(
      t.Object(
        {
...
export const ScreenshotPlainInputCreate = t.Object(
  { originalUrl: t.String(), previewUrl: t.Optional(__nullable__(t.String())) },
  { additionalProperties: false },
);

export const ScreenshotPlainInputUpdate = t.Object(
  {
    originalUrl: t.Optional(t.String()),
    previewUrl: t.Optional(__nullable__(t.String())),
  },
  { additionalProperties: false },
);

export const ScreenshotRelationsInputCreate = t.Object(
  {
    anime: t.Optional(
      t.Object(
        {
...
export const ScreenshotRelationsInputUpdate = t.Partial(
  t.Object(
    {
      anime: t.Partial(
        t.Object(
...
export const ScreenshotWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const ScreenshotWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const ScreenshotSelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
      originalUrl: t.Boolean(),
      previewUrl: t.Boolean(),
      anime: t.Boolean(),
      animeId: t.Boolean(),
      episode: t.Boolean(),
      episodeId: t.Boolean(),
...
export const ScreenshotInclude = t.Partial(
  t.Object(
    { anime: t.Boolean(), episode: t.Boolean(), _count: t.Boolean() },
    { additionalProperties: false },
  ),
);

export const ScreenshotOrderBy = t.Partial(
  t.Object(
    {
      ...
      previewUrl: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
...
export const Screenshot = t.Composite([ScreenshotPlain, ScreenshotRelations], {
  additionalProperties: false,
});

export const ScreenshotInputCreate = t.Composite(
  [ScreenshotPlainInputCreate, ScreenshotRelationsInputCreate],
  { additionalProperties: false },
);

export const ScreenshotInputUpdate = t.Composite(
  [ScreenshotPlainInputUpdate, ScreenshotRelationsInputUpdate],
  { additionalProperties: false },
);
