...
export const LicensorPlain = t.Object(
  {
    id: t.String(),
...
export const LicensorRelations = t.Object(
  {
    anime: t.Array(
      t.Object(
        {
...
export const LicensorPlainInputCreate = t.Object(
  {
    countries: t.Array(t.String(), { additionalProperties: false }),
    title: t.String(),
  },
...
export const LicensorPlainInputUpdate = t.Object(
  {
    countries: t.Optional(t.Array(t.String(), { additionalProperties: false })),
    title: t.Optional(t.String()),
  },
  { additionalProperties: false },
);

export const LicensorRelationsInputCreate = t.Object(
  {
    anime: t.Optional(
      t.Object(
        {
...
export const LicensorRelationsInputUpdate = t.Partial(
  t.Object(
    {
      anime: t.Partial(
        t.Object(
...
export const LicensorWhere = t.Partial(
  t.Recursive(
    (Self) =>
      t.Object(
        {
...
export const LicensorWhereUnique = t.Recursive(
  (Self) =>
    t.Intersect(
      [
        t.Partial(
...
export const LicensorSelect = t.Partial(
  t.Object(
    {
      id: t.Boolean(),
      countries: t.Boolean(),
...
export const LicensorInclude = t.Partial(
  t.Object(
...
export const LicensorOrderBy = t.Partial(
  t.Object(
    {
      id: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      countries: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
...
export const Licensor = t.Composite([LicensorPlain, LicensorRelations], {
  additionalProperties: false,
});

export const LicensorInputCreate = t.Composite(
  [LicensorPlainInputCreate, LicensorRelationsInputCreate],
  { additionalProperties: false },
);

export const LicensorInputUpdate = t.Composite(
  [LicensorPlainInputUpdate, LicensorRelationsInputUpdate],
  { additionalProperties: false },
);
